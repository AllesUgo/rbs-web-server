...
void RbsLib::Network::HTTP::HTTPServer::SetPostHandle(const std::function<int(const RbsLib::Network::TCP::TCPConnection& connection, RbsLib::Network::HTTP::RequestHeader& header, RbsLib::Buffer& post_content)>& func)
{
	this->on_post_request = func;
}

void RbsLib::Network::HTTP::HTTPServer::SetGetHandle(const std::function<int(const RbsLib::Network::TCP::TCPConnection& connection, RbsLib::Network::HTTP::RequestHeader& header)>& func)
{
